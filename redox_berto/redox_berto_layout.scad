...
redox_layout = [
    ...
    [[0.25, 0.375], [1.25, 1], [0, [0, 0]]], /* ` / Layer / 2 */
    [[1.5, 0.375], [1, 1], [0, [0, 0]]], /* ! / 1 */
    [[17.0, 0.375], [1, 1], [0, [0, 0]]], /* ) / 0 */
    [[18.0, 0.375], [1.25, 1], [0, [0, 0]]], /* - / Layer / 2 */
    [[6.5, 0.75], [1, 1], [0, [0, 0]]], /* Layer / 1 */
    [[12.0, 0.75], [1, 1], [0, [0, 0]]], /* Layer / 1 */
    [[3.5, 1.0], [1, 1], [0, [0, 0]]], /* E */
    ...
    [[3.5, 4.0], [1, 1], [0, [0, 0]]], /* * / ALT */
    [[15.0, 4.0], [1, 1], [0, [0, 0]]], /* Left */
    [[2.5, 4.125], [1, 1], [0, [0, 0]]], /* - */
    [[16.0, 4.125], [1, 1], [0, [0, 0]]], /* Down */
    [[0.5, 4.375], [1, 1], [0, [0, 0]]], /* GUI */
    [[1.5, 4.375], [1, 1], [0, [0, 0]]], /* + */
    [[17.0, 4.375], [1, 1], [0, [0, 0]]], /* Up */
    [[18.0, 4.375], [1, 1], [0, [0, 0]]], /* Right */
    [[5.75, -2.625], [1.25, 1], [15, [0, 0]]], /* \ / CTRL */
    [[6.5, 3.25], [1, 1], [30, [6.5, 4.25]]], /* PgUp */
    [[7.5, 3.25], [1, 1], [30, [6.5, 4.25]]], /* PgDn */
    [[6.5, 4.25], [1, 1.5], [30, [6.5, 4.25]]], /* Back / space */
    [[7.5, 4.25], [1, 1.5], [30, [6.5, 4.25]]], /* Del */
    [[11, 3.25], [1, 1], [-30, [13, 4.25]]], /* Home */
    [[12, 3.25], [1, 1], [-30, [13, 4.25]]], /* End */
    [[11, 4.25], [1, 1.5], [-30, [13, 4.25]]], /* Enter */
    [[12, 4.25], [1, 1.5], [-30, [13, 4.25]]], /* Space */
    [[11.75, 7.75], [1.25, 1], [-15, [0, 0]]], /* ALT */
];